...
export const DEFAULT_SETTINGS={enabled:true,minBatteryPercent:50,pollIntervalMinutes:10,requireAC:true,requireHome:true};
export function validateSettings(s){
 if(!s||typeof s!=='object'||Array.isArray(s)||Object.keys(s).length!==5||Object.keys(s).some(k=>!Object.hasOwn(DEFAULT_SETTINGS,k)))throw new Error('Invalid MacBook settings');
