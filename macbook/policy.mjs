...
export const DEFAULT_SETTINGS={enabled:true,minBatteryPercent:40,pollIntervalMinutes:10,requireAC:false,requireHome:false,promptrDailyTotal:2000,cognispecDailyTotal:2000};
